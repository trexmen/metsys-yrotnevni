...
$aksi="modul/transaksi-penjualan/ambil-simpan-data.php";
...
elseif($op=='tambah')
{
    ...
    // $tambah=mysql_query("INSERT INTO penjualan_tmp(id_barang,nama_barang,harga_jual,jumlah,subtotal)
    //                     VALUES('$id_barang','$nama_barang','$harga_jual','$jumlah','$subtotal')");
...
elseif($op=='simpan')
{
    ...
    $simpan=mysql_query("INSERT INTO penjualan(`id_penjualan`,`id_karyawan`,`id_pelanggan`,`minggu`,`tgl_pemesanan`,`tgl_pengiriman`,`catatan`,`status`,`total`)
                    VALUES ('$nota','$id_karyawan','$id_pelanggan','$minggu',NULL,NULL,NULL,'N','".$total."')");
    ...
    if($simpan)
    {
        ...
        $listOrder = $modOrder->getListOrder(); 
        foreach ($listOrder as $key => $value) {     
            mysql_query("INSERT INTO detail_penjualan(id_penjualan,id_barang,harga_jual,jumlah,subtotal)
