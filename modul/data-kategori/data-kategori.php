		    ...
		    <div class='row'>
		        <div class='col-xs-12'>			            
		            ...
		            <div class='box'>
		                ...
		                <div class='col-xs-12'>
		                <input type='button' value='Tambah Data' id='modal-data-kategori' act='tambah' class='btn btn-primary pull-left'></div><br/><br/>
		                    ...
		                    <table id='example3' class='table table-bordered table-striped'>
								...
								while($r=mysql_fetch_array($tampil)){
		                            ...
		                            <tr>
		                                ...
		                                <td><a href='#' id='modal-data-kategori' act='edit' data-id='$r[id_kategori]'><i class='fa fa-edit'></i> Edit</a></td>
		                            </tr>";
		                            $no++;
		                        }
